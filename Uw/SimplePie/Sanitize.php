...
/**
 * @todo Move to using an actual HTML parser (this will allow tags to be properly
 * stripped, and to switch between HTML and XHTML), this will also make it easier
 * to shorten a string while preserving HTML tags
 */
class SimplePie_Sanitize
{
    ...
    function pass_cache_data($enable_cache = true, $cache_location = './cache',
        $cache_name_function = 'md5', $cache_class = 'SimplePie_Cache')
    {
    ...
    function pass_file_data($file_class = 'SimplePie_File', $timeout = 10,
        $useragent = '', $force_fsockopen = false)
    {
        if ($file_class) {
